...
cfg.analysis['plotLFP'] = {'plots': ['timeSeries', 'PSD', 'spectrogram', 'locations'], 'electrodes': ['all'], 'maxFreq': 80, 'figSize': (8,4), 'saveData': False, 'saveFig': True, 'showFig': False} # 'PSD', 'spectrogram'

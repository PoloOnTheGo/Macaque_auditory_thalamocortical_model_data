...
cfg.analysis['plotLFP'] = {'plots': ['timeSeries', 'spectrogram', 'PSD'], 'electrodes': [0, 1, 2, 3], 'maxFreq': 80, 'figSize': (8,4), 'saveData': False, 'saveFig': True, 'showFig': False} # 'PSD', 'spectrogram'
